...
const FootSizeForm = () => {
  ...
  const slides = [
    <div className="container">
      ...
      <p className="title">ข้อมูลเท้ารหัสออเดอร์ 005</p>

      <div className="detailed">
        <button className="infButton" onClick={() => setShowTable(!showTable)}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" />
          </svg>
        </button>
        <p className="detailed-text">คำอธิบายเพิ่มเติม</p>
      </div>

      <form onSubmit={handleSubmit}>
        <div className="foot-size-form">
          <div className="foot-size-form__image">
          ...
          {showTable && (
            <table className="foot-measurement-table">
              <thead>
                <tr>
                  <th></th>
                  <th>คำอธิบาย</th>
          ...
          <div className="foot-size-form__measurements">
          ...
          <div className="foot-size-form__buttons">
  ...
  return (
    <main className="main">
      <div className="slideshow">{slides[currentSlide]}</div>
    </main>
  );
};
