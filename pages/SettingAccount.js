...
const SettingAccount = () => {
  ...
  // useEffect(() => {
  //   // Retrieve userId from the session cookie via API
  ...
  //       if (res.ok) {
  //         console.log('User ID:', data.userId); // ตรวจสอบ userId
  //         setUserId(data.userId); // Store the userId from session cookie
  //       } else {
